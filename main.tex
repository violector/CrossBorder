...
\begin{figure}[htbp]
\centering
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{(a) Terminal outputs}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_01a.pdf}\label{fig:overview_a}\end{subfigure}\hfill
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{(b) Final stage}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_01b.pdf}\label{fig:overview_b}\end{subfigure}

\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{(c) Max stage}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_01c.pdf}\label{fig:overview_c}\end{subfigure}\hfill
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{(d) Dominant risk}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_01d.pdf}\label{fig:overview_d}\end{subfigure}

\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{(e) Reward by output}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_01e.pdf}\label{fig:overview_e}\end{subfigure}\hfill
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{(f) Steps per episode}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_01f.pdf}\label{fig:overview_f}\end{subfigure}

\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{(g) Total action calls}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_01g.pdf}\label{fig:overview_g}\end{subfigure}\hfill
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{(h) Stages visited}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_01h.pdf}\label{fig:overview_h}\end{subfigure}
...
\begin{figure}[htbp]
\centering
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{(a) Total reward}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_02a.pdf}\end{subfigure}\hfill
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{(b) Total steps}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_02b.pdf}\end{subfigure}

\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{(c) \#Verify}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_02c.pdf}\end{subfigure}\hfill
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{(d) \#Escalate}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_02d.pdf}\end{subfigure}

\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{(e) \#Defer}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_02e.pdf}\end{subfigure}\hfill
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{(f) \#Redact}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_02f.pdf}\end{subfigure}

\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{(g) $g_\mathrm{minimal}$}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_02g.pdf}\end{subfigure}\hfill
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{(h) $g_\mathrm{prohibited}$}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_02h.pdf}\end{subfigure}
...
\begin{figure}[htbp]
\centering
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{(a) Proportional}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_03a.pdf}\end{subfigure}\hfill
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{(b) Absolute counts}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_03b.pdf}\end{subfigure}

\begin{subfigure}[t]{\textwidth}\centering\footnotesize\textbf{(c) Heatmap}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_03c.pdf}\end{subfigure}
...
\begin{figure}[htbp]
\centering
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{M1 -- Reasoning}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_04a.pdf}\end{subfigure}\hfill
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{M2 -- Verification}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_04b.pdf}\end{subfigure}

\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{M3 -- Fusion \& Mitigation}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_04c.pdf}\end{subfigure}\hfill
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{M4 -- Adjudication}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_04d.pdf}\end{subfigure}
...
\begin{figure}[htbp]
\centering
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{Evaluate}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_05a.pdf}\end{subfigure}\hfill
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{Mitigate}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_05b.pdf}\end{subfigure}

\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{Verify}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_05c.pdf}\end{subfigure}\hfill
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{Escalate}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_05d.pdf}\end{subfigure}

\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{Defer}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_05e.pdf}\end{subfigure}\hfill
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{Redact}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_05f.pdf}\end{subfigure}
...
\begin{figure}[htbp]
\centering
\begin{subfigure}[t]{0.43\textwidth}\centering\textbf{Total count}\par\vspace{2pt}\includegraphics[width=\textwidth]{figure_show/Fig_06a.pdf}\end{subfigure}\hfill
\begin{subfigure}[t]{0.43\textwidth}\centering\textbf{Row proportion (\%)}\par\vspace{2pt}\includegraphics[width=\textwidth]{figure_show/Fig_06b.pdf}\end{subfigure}
...
\begin{figure}[htbp]
\centering
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{Data type ($d$)}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_10a.pdf}\end{subfigure}\hfill
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{Biometric basis ($b$)}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_10b.pdf}\end{subfigure}

\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{Risk flag ($r$)}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_10c.pdf}\end{subfigure}\hfill
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{Compliance ($c$)}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_10d.pdf}\end{subfigure}

\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{Jurisdiction ($j$)}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_10e.pdf}\end{subfigure}\hfill
\begin{subfigure}[t]{0.43\textwidth}\centering\footnotesize\textbf{Metadata quality ($m$)}\par\vspace{1pt}\includegraphics[width=\textwidth]{figure_show/Fig_10f.pdf}\end{subfigure}
...
The simulation datasets generated and analysed during this study comprise two CSV files: (1) \texttt{results\_pipeline\_v1.csv} (33,331 rows $\times$ 40 columns), containing per-episode governance trajectories including the full action path, final decision output, cumulative reward, belief-state evolution, and input feature values for every simulated episode; and (2) \texttt{transition\_pipeline\_v1.csv}, containing the aggregated state--action--transition counts from which all transition probability matrices and force-directed graphs were derived. Both files, together with documented column-header descriptions and the random seeds used for stratified sampling, are deposited in the Figshare repository at \url{https://doi.org/XXXXX}. Source data underlying all figures are provided with this paper.

\section{Code availability}
The full implementation is available at \url{https://github.com/XXXXX/crossborder-ai-governance} and comprises three components: (i) \texttt{cross\_pipeline\_mdp\_v1.py}, the training environment implementing the pipeline MDP with the DQN agent, Bayesian belief propagation, admissible-action filtering, and the complete reward structure; (ii) \texttt{cross\_analysis\_pipeline\_split.py}, the figure-generation pipeline that produces all 40 individual panel figures from the simulation outputs; and (iii) configuration files documenting all parameter values (transition probabilities, reward weights, resource budgets, and constraint thresholds). The repository includes a requirements file for Python dependency resolution and a README with step-by-step reproduction instructions. An interactive Google Colab notebook that reproduces the core training and analysis workflow without local installation is available at \url{https://colab.research.google.com/XXXXX}. All code is released under the MIT License.
